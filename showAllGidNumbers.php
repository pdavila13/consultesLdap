...
// Search all users
$sr=ldap_search($ds,"ou=All,dc=iesebre,dc=com", "(gidNumber=*)");   
...
sort($gidnumbers);
$uniquegidnumbers = array_unique ($gidnumbers);
foreach ($uniquegidnumbers as $key => $val) {
    echo "uniquegidnumbers[" . $key . "] = " . $val . "\n";
}
